...
func main() {
	...
	if err := writeUserContentManagerExtras(dir); err != nil {
		panic(err)
	}
}
...
func writeUserContentManagerExtras(dir string) error {
	const userContentManagerExtras = `// Code generated by puregotk-webkit extras; DO NOT EDIT.
package webkit
...
`
	...
	path := filepath.Join(webkitDir, "WebKitUserContentManagerExtras.go")
	return os.WriteFile(path, []byte(userContentManagerExtras), 0o644)
}
