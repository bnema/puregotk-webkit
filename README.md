...
Autogenerated WebKitGTK 6 bindings for Go leveraging [purego](https://github.com/bnema/purego) - no Cgo required.
...
- [Purego](https://github.com/bnema/purego) and the ebitengine team
