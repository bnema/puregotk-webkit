...
func ContextMenuItemGLibType() types.GType {
	core.LazyRegister(&xContextMenuItemGLibType, "WEBKITWEBPROCESSEXTENSION", "webkit_context_menu_item_get_type", false)
...
func NewContextMenuItemFromGaction(ActionVar gio.Action, LabelVar string, TargetVar *glib.Variant) *ContextMenuItem {
	core.LazyRegister(&xNewContextMenuItemFromGaction, "WEBKITWEBPROCESSEXTENSION", "webkit_context_menu_item_new_from_gaction", false)
...
func NewContextMenuItemFromStockAction(ActionVar ContextMenuAction) *ContextMenuItem {
	core.LazyRegister(&xNewContextMenuItemFromStockAction, "WEBKITWEBPROCESSEXTENSION", "webkit_context_menu_item_new_from_stock_action", false)
	var cls *ContextMenuItem
...
func NewContextMenuItemFromStockActionWithLabel(ActionVar ContextMenuAction, LabelVar string) *ContextMenuItem {
	core.LazyRegister(&xNewContextMenuItemFromStockActionWithLabel, "WEBKITWEBPROCESSEXTENSION", "webkit_context_menu_item_new_from_stock_action_with_label", false)
	var cls *ContextMenuItem
...
func NewContextMenuItemSeparator() *ContextMenuItem {
	core.LazyRegister(&xNewContextMenuItemSeparator, "WEBKITWEBPROCESSEXTENSION", "webkit_context_menu_item_new_separator", false)
	var cls *ContextMenuItem
...
func NewContextMenuItemWithSubmenu(LabelVar string, SubmenuVar *ContextMenu) *ContextMenuItem {
	core.LazyRegister(&xNewContextMenuItemWithSubmenu, "WEBKITWEBPROCESSEXTENSION", "webkit_context_menu_item_new_with_submenu", false)
	var cls *ContextMenuItem
...
func (x *ContextMenuItem) GetGaction() *gio.ActionBase {
	core.LazyRegister(&xContextMenuItemGetGaction, "WEBKITWEBPROCESSEXTENSION", "webkit_context_menu_item_get_gaction", false)
...
func (x *ContextMenuItem) GetGactionTarget() *glib.Variant {
	core.LazyRegister(&xContextMenuItemGetGactionTarget, "WEBKITWEBPROCESSEXTENSION", "webkit_context_menu_item_get_gaction_target", false)
...
func (x *ContextMenuItem) GetStockAction() ContextMenuAction {
	core.LazyRegister(&xContextMenuItemGetStockAction, "WEBKITWEBPROCESSEXTENSION", "webkit_context_menu_item_get_stock_action", false)
...
func (x *ContextMenuItem) GetSubmenu() *ContextMenu {
	core.LazyRegister(&xContextMenuItemGetSubmenu, "WEBKITWEBPROCESSEXTENSION", "webkit_context_menu_item_get_submenu", false)
	var cls *ContextMenu
...
func (x *ContextMenuItem) GetTitle() string {
	core.LazyRegister(&xContextMenuItemGetTitle, "WEBKITWEBPROCESSEXTENSION", "webkit_context_menu_item_get_title", false)
...
func (x *ContextMenuItem) IsSeparator() bool {
	core.LazyRegister(&xContextMenuItemIsSeparator, "WEBKITWEBPROCESSEXTENSION", "webkit_context_menu_item_is_separator", false)
...
func (x *ContextMenuItem) SetSubmenu(SubmenuVar *ContextMenu) {
	core.LazyRegister(&xContextMenuItemSetSubmenu, "WEBKITWEBPROCESSEXTENSION", "webkit_context_menu_item_set_submenu", false)
