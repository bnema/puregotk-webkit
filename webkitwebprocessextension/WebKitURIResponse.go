...
func URIResponseGLibType() types.GType {
	core.LazyRegister(&xURIResponseGLibType, "WEBKITWEBPROCESSEXTENSION", "webkit_uri_response_get_type", false)
...
func (x *URIResponse) GetContentLength() uint64 {
	core.LazyRegister(&xURIResponseGetContentLength, "WEBKITWEBPROCESSEXTENSION", "webkit_uri_response_get_content_length", false)
...
func (x *URIResponse) GetHttpHeaders() *soup.MessageHeaders {
	core.LazyRegister(&xURIResponseGetHttpHeaders, "WEBKITWEBPROCESSEXTENSION", "webkit_uri_response_get_http_headers", false)
...
func (x *URIResponse) GetMimeType() string {
	core.LazyRegister(&xURIResponseGetMimeType, "WEBKITWEBPROCESSEXTENSION", "webkit_uri_response_get_mime_type", false)
...
func (x *URIResponse) GetStatusCode() uint {
	core.LazyRegister(&xURIResponseGetStatusCode, "WEBKITWEBPROCESSEXTENSION", "webkit_uri_response_get_status_code", false)
...
func (x *URIResponse) GetSuggestedFilename() string {
	core.LazyRegister(&xURIResponseGetSuggestedFilename, "WEBKITWEBPROCESSEXTENSION", "webkit_uri_response_get_suggested_filename", false)
...
func (x *URIResponse) GetUri() string {
	core.LazyRegister(&xURIResponseGetUri, "WEBKITWEBPROCESSEXTENSION", "webkit_uri_response_get_uri", false)
